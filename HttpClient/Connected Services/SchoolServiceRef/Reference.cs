...
namespace HttpClient.SchoolServiceRef {
    ...
    public interface ISchoolService {
        ...
        HttpClient.SchoolServiceRef.Student AddStudent(string lastName, string firstName, System.DateTime dob, HttpClient.SchoolServiceRef.GenderEnum gender, string id, string major, float units, float gpa);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISchoolService/AddStudent", ReplyAction="http://tempuri.org/ISchoolService/AddStudentResponse")]
        System.Threading.Tasks.Task<HttpClient.SchoolServiceRef.Student> AddStudentAsync(string lastName, string firstName, System.DateTime dob, HttpClient.SchoolServiceRef.GenderEnum gender, string id, string major, float units, float gpa);
        ...
        HttpClient.SchoolServiceRef.Student UpdateStudent(string lastName, string firstName, System.DateTime dob, HttpClient.SchoolServiceRef.GenderEnum gender, string id, string major, float units, float gpa);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISchoolService/UpdateStudent", ReplyAction="http://tempuri.org/ISchoolService/UpdateStudentResponse")]
        System.Threading.Tasks.Task<HttpClient.SchoolServiceRef.Student> UpdateStudentAsync(string lastName, string firstName, System.DateTime dob, HttpClient.SchoolServiceRef.GenderEnum gender, string id, string major, float units, float gpa);
        ...
        HttpClient.SchoolServiceRef.Teacher AddTeacher(string lastName, string firstName, System.DateTime dob, HttpClient.SchoolServiceRef.GenderEnum gender, int idTeacher, System.DateTime dateofhire, int salary);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISchoolService/AddTeacher", ReplyAction="http://tempuri.org/ISchoolService/AddTeacherResponse")]
        System.Threading.Tasks.Task<HttpClient.SchoolServiceRef.Teacher> AddTeacherAsync(string lastName, string firstName, System.DateTime dob, HttpClient.SchoolServiceRef.GenderEnum gender, int idTeacher, System.DateTime dateofhire, int salary);
    ...
    public partial class SchoolServiceClient : System.ServiceModel.ClientBase<HttpClient.SchoolServiceRef.ISchoolService>, HttpClient.SchoolServiceRef.ISchoolService {
        ...
        public HttpClient.SchoolServiceRef.Student AddStudent(string lastName, string firstName, System.DateTime dob, HttpClient.SchoolServiceRef.GenderEnum gender, string id, string major, float units, float gpa) {
            return base.Channel.AddStudent(lastName, firstName, dob, gender, id, major, units, gpa);
        }
        
        public System.Threading.Tasks.Task<HttpClient.SchoolServiceRef.Student> AddStudentAsync(string lastName, string firstName, System.DateTime dob, HttpClient.SchoolServiceRef.GenderEnum gender, string id, string major, float units, float gpa) {
            return base.Channel.AddStudentAsync(lastName, firstName, dob, gender, id, major, units, gpa);
        }
        ...
        public HttpClient.SchoolServiceRef.Student UpdateStudent(string lastName, string firstName, System.DateTime dob, HttpClient.SchoolServiceRef.GenderEnum gender, string id, string major, float units, float gpa) {
            return base.Channel.UpdateStudent(lastName, firstName, dob, gender, id, major, units, gpa);
        }
        
        public System.Threading.Tasks.Task<HttpClient.SchoolServiceRef.Student> UpdateStudentAsync(string lastName, string firstName, System.DateTime dob, HttpClient.SchoolServiceRef.GenderEnum gender, string id, string major, float units, float gpa) {
            return base.Channel.UpdateStudentAsync(lastName, firstName, dob, gender, id, major, units, gpa);
        }
        
        public HttpClient.SchoolServiceRef.Teacher AddTeacher(string lastName, string firstName, System.DateTime dob, HttpClient.SchoolServiceRef.GenderEnum gender, int idTeacher, System.DateTime dateofhire, int salary) {
            return base.Channel.AddTeacher(lastName, firstName, dob, gender, idTeacher, dateofhire, salary);
        }
        
        public System.Threading.Tasks.Task<HttpClient.SchoolServiceRef.Teacher> AddTeacherAsync(string lastName, string firstName, System.DateTime dob, HttpClient.SchoolServiceRef.GenderEnum gender, int idTeacher, System.DateTime dateofhire, int salary) {
            return base.Channel.AddTeacherAsync(lastName, firstName, dob, gender, idTeacher, dateofhire, salary);
        }
